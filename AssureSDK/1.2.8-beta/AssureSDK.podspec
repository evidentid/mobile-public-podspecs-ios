...
Pod::Spec.new do |s|
  ...
  s.author      = { 'rcheema' => 'rcheema@evidentid.com' }
  s.source = {
    :http => "https://github.com/evidentidpublic/mobile-AssureSDK-iOS/releases/download/1.2.8/AssureSDK.zip"
  }
  s.swift_version         = '5.0'
